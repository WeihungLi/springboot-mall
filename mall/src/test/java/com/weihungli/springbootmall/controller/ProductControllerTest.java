...
public class ProductControllerTest {
    ...
    public void getProduct_success() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.productCategory", equalTo("FOOD")))
                .andExpect(jsonPath("$.productImgUrl", notNullValue()))
                .andExpect(jsonPath("$.productPrice", notNullValue()))
                .andExpect(jsonPath("$.productStock", notNullValue()))
                .andExpect(jsonPath("$.productDesc", notNullValue()))
                .andExpect(jsonPath("$.productCreateTime", notNullValue()))
                .andExpect(jsonPath("$.productModifiedTime", notNullValue()));
    }
    ...
    public void createProduct_success() throws Exception {
        ...
        productRequest.setProductImgUrl("http://test.com");
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.productCategory", equalTo("FOOD")))
                .andExpect(jsonPath("$.productImgUrl", equalTo("http://test.com")))
                .andExpect(jsonPath("$.productPrice", equalTo(100)))
                .andExpect(jsonPath("$.productStock", equalTo(2)))
                .andExpect(jsonPath("$.productDesc", nullValue()))
                .andExpect(jsonPath("$.productCreateTime", notNullValue()))
                .andExpect(jsonPath("$.productModifiedTime", notNullValue()));
    }
